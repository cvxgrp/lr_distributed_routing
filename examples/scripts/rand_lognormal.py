...
G = ldr.create_random_ij_lognormal_graph(n, sigma=sigma)
...
output_path = os.path.join(parent_dir, 'outputs/%s_nsp%d_rank%d_n%d_rf%d_s%d.pickle' % (mtype, args.nsamples, rank, n, int(rand_frac*100), int(100 * sigma)))
